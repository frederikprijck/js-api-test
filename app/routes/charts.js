...
const getGraphsById = (req, res) => {
  ...
  const str = `[{"date":"${yyyy}-${mm}-01", "s1":31, "s2":263, "s3":159, "s4":22, "s5":270},{"date":"${yyyy}-${mm}-02", "s1":14, "s2":260, "s3":158, "s4":12, "s5":276},{"date":"${yyyy}-${mm}-03", "s1":24, "s2":265, "s3":164, "s4":19, "s5":269},{"date":"${yyyy}-${mm}-04", "s1":23, "s2":269, "s3":168, "s4":19, "s5":276},{"date":"${yyyy}-${mm}-05", "s1":25, "s2":272, "s3":168, "s4":17, "s5":279},{"date":"${yyyy}-${mm}-06", "s1":5, "s2":259, "s3":160, "s4":3, "s5":283},{"date":"${yyyy}-${mm}-07", "s1":5, "s2":257, "s3":159, "s4":4, "s5":288}]`;
  res.send(JSON.parse(str));
};
